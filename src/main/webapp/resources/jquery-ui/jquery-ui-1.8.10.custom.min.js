...
(function (e) {
    ...
    e.extend(e.ui.selectable, {version: "1.8.10"})
})(jQuery);
;
/*
...
(function (c) {
    ...
    c.extend(c.ui.accordion, {version: "1.8.10", animations: {slide: function (a, b) {
        a =
...
(function (c, j) {
    ...
    c.extend(c.ui.dialog, {version: "1.8.10", uuid: 0, maxZ: 0, getTitleId: function (a) {
        a = a.attr("id");
        if (!a) {
            this.uuid += 1;
            a = this.uuid
...
(function (d) {
    ...
    d.extend(d.ui.slider, {version: "1.8.10"})
})(jQuery);
;
/*
